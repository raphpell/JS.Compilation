...
["ATTRIBUTE_SELECTOR",(function(a0,a1,a2,a3){return {A:g("["+a0+"]","["+a1+"]","\\","é","-","=","\"","'","["+a2+"]","["+a3+"]","]","[^\\é-=\"']"+a0+a1+a2+a3+"]"),M:[,[3,3,2,3,4,8,6,7,,5,9],h(12,3),[3,3,2,3,3,,,,3],[3,3,2,3],{5:8}],F:[,,,3,,,1,2,4,5],R:[[0,f(a0,1)],[1,f(a1,1)],[8,f(a2,1)],[9,f(a3,1)],[11,f("\\é-=\"']"+a0+a1+a2+a3+"")]],TokensTable:[,'S_SDQ','S_SSQ','IDENT','ATTRIBUTE_OPERATOR','E_ATTRIBUTE_SELECTOR']}})
(
	"ABCDEFabcdef",
...
["RULE_SET",(function(a0,a1,a2){return {A:g("p","h","["+a0+"]","["+a1+"]","\\","é","-","\t","\n"," ","["+a2+"]","*","/",":","<","=","?","}","\f","\r","[^ph\\é-\t\n */:<=?}\f\r"+a0+a1+a2+"]"),M:[,[3,3,3,3,2,3,4,13,11,14,,,7,16,8,,,17,11,6],h(21,3,8,0,18,0,19,0),[3,3,3,3,2,3,3,,,,3],h(6,3,4,2),{0:9,15:12},{8:11},{11:15},{16:5},[,10],[12]],F:[,,,4,,,2,,,,,2,7,1,3,5,6,8],R:[[2,f(a0,1)],[3,f(a1,1)],[10,f(a2,1)],[20,f("ph\\é-\t\n */:<=?}\f\r"+a0+a1+a2+"")]],TokensTable:',TAB,L_NEW_LINE,SPACES,IDENT,S_MLC,S_PROP_VALUE,S_PHP,E_RULE_SET'.split(',')}})
(
	"ABCDEFabcdef",
	"GHIJKLMNOPQRSTUVWXYZ_gijklmnoqrstuvwxyz",
	"0123456789"
)],
["PROP_VALUE",(function(a0,a1,a2){return {A:g("["+a0+"]","m","h","p","c","d","e","g","r","s","i","k","x","a","n","t","z","-","["+a1+"]","["+a2+"]","\\","l","u","é",".","%","(","/","\t"," ","!","\"","#","'","*","+",",",";","<","=","?","[^mhpcdegrsikxantz-\\lué.%(/\t !\"#'*+,;<=?"+a0+a1+a2+"]"),M:[,[12,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,10,4,4,2,4,5,4,29,38,,33,40,41,42,43,9,44,,38,45,47,34],h(42,4),h(42,8),h(27,4,20,2,24,0,25,0,26,37),h(27,4,8,6,20,2,24,0,25,0,26,37),h(27,4,20,2,21,7,24,0,25,0,26,37),h(27,4,20,2,24,0,25,0,26,48),h(24,8,20,3),h(24,8,20,3),h(25,4,0,12,17,0,20,2,24,29),[11,18,23,15,24,25,17,26,22,21,27,28,,,,,,,,,,,,,30,21],[12,18,23,15,24,25,17,26,22,21,27,28,,,,,,,,,,,,,29,21],[13,18,23,15,24,25,17,26,22,21,27,28,,,,,,,,,,,,,,21],[14,18,23,15,24,25,17,26,22,21,27,28,,,,,,,,,,,,,,21],{4:21,12:21,15:21},{0:11,17:19,24:30},{1:21,12:21},{1:21,9:21},{0:11,24:30},{3:35,39:39},{27:16},{13:32},{16:21},[,21],{6:31},{8:22},{14:21},[,,23],[13],[14],{7:21},{5:21},{34:46},{40:20},[,,36],{3:39}],F:[,,,,11,11,11,11,5,,6,,9,9,,,,,,,,10,,,,,,,,,,,,,,,,12,6,15,1,2,3,4,7,8,13,14,16],R:[[0,f(a0,1)],[18,f(a1,1)],[19,f(a2,1)],[41,f("mhpcdegrsikxantz-\\lué.%(/\t !\"#'*+,;<=?"+a0+a1+a2+"")]],TokensTable:',TAB,SPACES,S_IMPORTANT,S_SDQ,HASH,CSS_PHP_BUG,S_SSQ,ELISION,NUMBER,DIMENSIONS,IDENT,S_FUNCTION,S_MLC,E_PROP_VALUE,S_PHP,S_URL'.split(',')}})
(
	"0123456789",
	"ABCDEFbf",
	"GHIJKLMNOPQRSTUVWXYZ_joqvwy"
)],
["PSEUDO",(function(a0,a1,a2){return {A:g("["+a0+"]","["+a1+"]","\\","é","-","(","["+a2+"]","[^\\é-("+a0+a1+a2+"]"),M:[,[3,3,2,3,4],h(8,3),h(7,3,2,2,5,5),[3,3,2,3]],F:[,,,1,,2],R:[[0,f(a0,1)],[1,f(a1,1)],[6,f(a2,1)],[7,f("\\é-("+a0+a1+a2+"")]],TokensTable:[,'IDENT','S_FUNCTION']}})
(
	"ABCDEFabcdef",
	"GHIJKLMNOPQRSTUVWXYZ_ghijklmnopqrstuvwxyz",
	"0123456789"
...
["URL",(function(a0,a1){return {A:g("<","=","?","["+a0+"]","["+a1+"]","\\","h","p","é","\t","\n"," ","\"","'",")","\f","\r","[^<=?\\hpé\t\n \"')\f\r"+a0+a1+"]"),M:[,[5,3,3,3,3,2,3,3,3,11,10,12,13,14,15,10,9],h(18,3,5,2,10,0,15,0,16,0),h(9,3,5,2),h(9,3,5,2),h(9,3,2,6,5,2),h(9,3,1,4,5,2,7,7),h(9,3,5,2,6,8),h(9,3,5,2,7,4),{10:10}],F:[,1,1,1,8,1,1,1,1,3,3,2,4,5,6,7],R:[[3,f(a0,1)],[4,f(a1,1)],[17,f("<=?\\hpé\t\n \"')\f\r"+a0+a1+"")]],TokensTable:',PATH,TAB,L_NEW_LINE,SPACES,S_SDQ,S_SSQ,E_URL,S_PHP'.split(',')}})
(
	"!#$%&*+,-./:;>@GHIJKLMNOPQRSTUVWXYZ[]^_`gijklmnoqrstuvwxyz{|}~",
	"0123456789ABCDEFabcdef"
)],
["FUNCTION",(function(a0,a1,a2,a3){return {A:g("p","h","-","["+a0+"]","["+a1+"]","["+a2+"]","\\","é","=","?","\t"," ",")",",","<","[^\n\f\r0123456789ABCDEFabcdefGHIJKLMNOPQRSTUVWXYZ_ghijklmnopqrstuvwxyz-é\\\t ,<?=)"+a3+"]","[{}]","\n","\f","\r"),M:[,[5,5,7,6,5,5,4,5,14,14,16,17,18,19,10,14,,13,13,9],h(17,5),h(17,6),h(17,5),h(8,5,6,2),h(8,6,6,3),[5,5,6,6,5,5,2,5],{0:11,8:15},{17:13},{9:8},[,12],[15]],F:[,,,,8,7,6,6,,2,8,,,2,8,9,1,3,4,5],R:[[3,f(a0,1)],[4,f(a1,1)],[5,f(a2,1)],[15,f("ph-\\é=?\t ),<\n\f\r"+a0+a1+a2+a3+"")],[16,f(a3,1)]],TokensTable:',TAB,L_NEW_LINE,SPACES,E_FUNCTION,ELISION,NAME,IDENT,FUNCTION_ARG,S_PHP'.split(',')}})
(
	"0123456789",
	"ABCDEFabcdef",
	"GHIJKLMNOPQRSTUVWXYZ_gijklmnoqrstuvwxyz",
