;(function(){
	...
	o.addRules([
		...
		['MLC','S_PHP|TAB|SPACES|L_NEW_LINE|E_MLC|MLC_IN'],
		['SLC','S_PHP|TAB|SPACES|SLC_IN']
		])
	...
	o.addTokens([
		...
		['PHP_IDENTIFIER',/\$[\w_]+/],
		['PHP_SPECIAL_VARS',/(?:\$(GLOBALS|_(?:COOKIE|ENV|FILES|GET|(?:PO|REQUE)ST|SE(?:RVER|SSION))))\b/],
		...
		['PHP_RESERVED',/(?:exception|as|var|class|const|die|echo|empty|eval|exit|extends|function|global|isset|list|new|print|static|unset|use|__FUNCTION__|__CLASS__|__METHOD__|final|interface|implements|extends|public|private|protected|abstract|clone|\$this)\b/],
		['PHP_ARITHMETIC_OP',/\+\+?|\-\-?|\*|\%|\//],
		['PHP_ASSIGNMENT_OP',/\+=|\-=|\*=|\/=|\.=|\%=|\&=|\|=|\^=|<<=|>>=|=>?/],
		['PHP_BITWISE_OP',/&|\||\^|\~|<<|>>/],
		['PHP_COMPARISON_OP',/===?|!==?|<>|<=?|>=?/],
	...
	o.addRules([
		['BIG_PHP', 'E_PHP|NUMBER|L_NEW_LINE|TAB|SPACES|S_SLC|S_MLC|PHP_COMPARISON_OP|PHP_ASSIGNMENT_OP|PHP_ARITHMETIC_OP|PHP_LOGICAL_OP|PHP_BITWISE_OP|PHP_ERROR_CONTROL_OP|PHP_STRING_OP|PHP_TYPE_OP|S_SSQ|S_SDQ|ELISION|LBRACE|RBRACE|LPAREN|RPAREN|LBRACK|RBRACK|DOT|SEMI|QUESTION|COLON'],
		['PHP_ID', 'PHP_RESERVED|PHP_LITERAL|PHP_KEYWORD|PHP_SPECIAL_VARS|PHP_FUNCTION|PHP_IDENTIFIER'],
		['PHP', 'S_PHP|BIG_PHP|PHP_ID|NOT_WHITE_SPACES' ]
		])
	o.addCSSClass([
	...
	o.addRules([
		['BIG_CSS','S_PHP|L_NEW_LINE|TAB|SPACES|S_MLC|S_ATTRIBUTE_SELECTOR|ELISION|ATKEYWORD|HASH|CLASS|S_PSEUDO|COMBINATOR|IDENT|S_RULE_SET|CSS_ERROR'],
